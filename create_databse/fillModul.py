...
c.execute('''DELETE FROM BRIDGE_MODUL_PERSON''')
...
for person in personen:
	...
	c.execute('INSERT INTO Person VALUES (?,?,?,?,?)', [i, person['friedolinID'],person['vorname'],person['nachname'],person['grad'],])
	i += 1
